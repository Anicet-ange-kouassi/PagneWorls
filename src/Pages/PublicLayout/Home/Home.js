    ...
    return (
        <div>
            <div className="h-[20vh] bg-gradient-to-r from-purple-500 to-pink-500 pt-20">
                <h1 className="text-gray-50 text-5xl items-center  text-center">novelty on African loincloths!!</h1>
            </div>
            <h1 className=" rounded p-3 items-center text-5xl  text-center font-bold">Le temple de la culture africaine</h1>
